package com.example.myapplication.activity_scan
...
import com.example.myapplication.data.BluetoothLEManager
import com.example.myapplication.data.Device
import com.example.myapplication.data.DeviceViewHolder
...
// L'Adapter permettant de se connecter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rvDevices.setup {
            ...
            withItem<Device, DeviceViewHolder>(R.layout.item_device) {
                ...
                onClick {
                    Toast.makeText(this@ScanActivity, getString(R.string.connexion_str, item.name), Toast.LENGTH_SHORT).show()
    ...
    private fun setUiMode(isConnected: Boolean) {
        if (isConnected) {
            ...
            binding.currentConnexion.text = getString(R.string.connected_to, BluetoothLEManager.currentDevice?.name)
